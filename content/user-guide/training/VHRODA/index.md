...
sections:
  ...
  - block: features
    ...
    content:
      ...
      items:
        - name: '<a href="https://colab.research.google.com/github/comet-toolkit/comet_training/blob/main/VHRODA_training_exercise1.ipynb" style="color: blue; font-style: underline;">Exercise 1: Introduction to Punpy Capabilities</a>'
          icon: code-bracket
