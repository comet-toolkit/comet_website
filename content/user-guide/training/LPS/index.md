...
sections:
  ...
  - block: features
    ...
    content:
      ...
      items:
        - name: "[**Exercise 1**: Introduction to Punpy Capabilities \n (Click here to open exercise)](https://colab.research.google.com/github/comet-toolkit/comet_training/blob/main/LPS_training_exercise1.ipynb)"
          icon: code-bracket
        ...
        - name: "[**Exercise 2**: Multi-Dimension Datasets \n (Click here to open exercise)](https://colab.research.google.com/github/comet-toolkit/comet_training/blob/main/LPS_training_exercise2.ipynb)"
          icon: star
        ...
        - name: "[**Exercise 3**: HYPERNETS Use Case  \n (Click here to open exercise)](https://colab.research.google.com/github/comet-toolkit/comet_training/blob/main/LPS_training_exercise3.ipynb)"
          icon: sparkles
